...
export const AboutDescription = () => {
    ...
    return (
        <div className="AboutMe-Container">
            ...
            <p className="About-Description">I am a {calculateYears(new Date(2004, 7, 16))}-year-old with {calculateYears(new Date(2023, 0, 17))} year(s) of experience. My interest in coding began in my second semester at Pellissippi when I took the CISP 1010 course; I was unsure of what to major in and was curious about the subject since I previously did a little coding for my STEM Club activities. As the semester went by, I fell in love with coding and decided to become a Computer Science major. I am intrigued by artificial intelligence and machine learning, so I plan to minor in artificial intelligence along with my CS major. I am constantly improving myself and broadening my skills, so I plan to gain practical experience and mentorship via internships. With these experiences, I would love to help others through utilizing this knowledge by becoming a TA.</p>
        </div>
    );
};
